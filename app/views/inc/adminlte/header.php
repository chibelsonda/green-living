...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/adminlte/dist/css/skins/skin-blue.min.css">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?php echo URLROOT; ?>" class="logo">
                ...
                <span class="logo-lg"> <b>Green Living</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <!-- User Image -->
                                                    <img src="<?php echo URLROOT; ?>/adminlte/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                                </div>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="<?php echo URLROOT; ?>/adminlte/dist/img/avatar5.png" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="<?php echo URLROOT; ?>/adminlte/dist/img/avatar5.png" class="img-circle" alt="User Image">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo URLROOT; ?>/users/profile/<?php echo $_SESSION['user_id']; ?>" class="btn btn-default btn-flat">Profile</a>
                                    </div>
        ...
        <?php require APPROOT . '/views/inc/adminlte/sidebar.php';  ?>  
